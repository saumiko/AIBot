...
public class Main implements KeyListener, /*MouseListener, MouseMotionListener*/ Runnable {
    ...
    static public Image open, play, help, about, exit, onePlayer, twoPlayer, background1, background2, knight1, knight2, attack1, attack2, defence1, defence2, server, client, lose, win, aboutm, helpm;
