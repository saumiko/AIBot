...
public class OnePlayerCollision extends Main /*implements MouseListener, MouseMotionListener*/ {
    ...
    void Collision(Graphics2D g) {
        for (row = 1; row <= 9; row++) {
            for (column = 1; column <= 13; column++) {
                ...
                // ARROW ME
                if (Player[row][column] == 1 && Character[row][column] == 1 && Player[row][column + 4] == 2 && column + 4 <= 13) {
                ...
                if (Player[row][column] == 1 && Character[row][column] == 1 && Player[row][column + 3] == 2 && column + 3 <= 13) {
                ...
                if (Player[row][column] == 1 && Character[row][column] == 1 && Player[row][column + 2] == 2 && column + 2 <= 13) {
                ...
                if (Player[row][column] == 2 && Character[row][column] == 1 && Player[row][column - 4] == 1 && column - 4 >= 1) {
                    if (Player[row][column - 1] == 0 && Player[row][column - 2] == 0 && Player[row][column - 3] == 0) {
                ...
                if (Player[row][column] == 2 && Character[row][column] == 1 && Player[row][column - 3] == 1 && column - 3 >= 1) {
                    if (Player[row][column - 1] == 0 && Player[row][column - 2] == 0) {
                        int sumAI = Attack[row][column] + Defence[row][column];
                ...
                if (Player[row][column] == 2 && Character[row][column] == 1 && Player[row][column - 2] == 1 && column + 2 <= 13) {
                    if (Player[row][column + 1] == 0) {
                        int sumAI = Attack[row][column] + Defence[row][column];
                ...
                if (Player[row][column] == 1 && Player[row][column + 1] == 2) {
                    ...
                    if(Character[row][column]==4){
                        Player[row][column+1]=0;
                        Player[row][column]=0;
                    }
                    else if(Character[row][column+1]==4){
                        Player[row][column+1]=0;
                        Player[row][column]=0;
                    }
                    else{
